...
- **週期**：每月
- **結束日期**：今年 12 月 31 日
- **結果**：每月 1 號 18:00 前都會有「整理衣櫃」的工作，直到年底
...
2. **自動生成時機**：只有在頁面載入時才會檢查，不是即時的
3. **結束日期**：如果不設定結束日期，工作會持續生成
4. **已生成的工作**：刪除原始週期性工作不會影響已生成的工作
5. **每週選擇**：使用每週模式時，至少要選擇一天
